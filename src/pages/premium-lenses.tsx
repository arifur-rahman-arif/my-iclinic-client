...
import { premiumLensesFaqList } from '@/components/page-sections/Faq/faqList';
import { leftRightListPremiumLenses } from '@/components/page-sections/LeftRight/leftRightList';
