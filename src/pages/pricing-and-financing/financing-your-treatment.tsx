...
import { FinanceCalculator } from '@/components/page-sections';
...
import FinanceHeroSection from '@/page-sections/Masthead/FinanceHeroSection';
...
export default function FinancingYourTreatment({
    ...
    return (
        <Page title={heading} description={subheading} seo={seo} yoastJson={yoastJson}>
            <BreadCrumb className="md:flex md:pb-4 xl:hidden" />
            ...
            <FinanceHeroSection
                ...
                h2Title={<h2 className="!text-[1.6rem] !uppercase !leading-[2.4rem] !text-white">{subheading}</h2>}
                priceText={<></>}
                bannerExtraComponents={
                    <div className="grid place-items-center gap-4 sm:grid-flow-col sm:place-items-start sm:justify-start">
                        <Button2
                            type="button"
                            text="Finance calculator"
                            iconPosition="left"
                            className="group/chat-button !bg-[#0099FF] normal-case hover:!border-white hover:!bg-transparent hover:text-white"
                            onClick={() => {
                                window.scrollTo(
                                    0,
                            ...
                            //             fill="#fff"
                            //             className="transition-all duration-500 group-hover/chat-button:fill-white"
                            //         />
                            //     </svg>
                            // }
                        />
                        ...
                        <Button2
                            ...
                            iconPosition="left"
                            className="group/chat-button bg-[#94CAFF] normal-case text-heading hover:border-[#94CAFF] hover:!bg-transparent hover:text-white"
                            onClick={() => {
                                window.scrollTo(
                                    0,
            ...
            <FullWidthImageSection4
                boldHeading={
                    <div className="font-latoBold !normal-case text-heading md:max-w-[54.4rem]">
                ...
                // }
                description={[
                    <H3Variant2 className="!text-[2rem] !uppercase !leading-[2.8rem] text-[#293C4E]">
                        How much do you currently spend on your glasses and contact lenses?
                    </H3Variant2>,
                    <p className="text-[#293C4E]">
                    ...
                    {/** data?.calculator_heading */}
                    {
                        <>
                            <div className="grid place-items-center gap-6">
                                <span className="font-latoBold text-[2rem] uppercase leading-[2.8rem] text-heading">
                                    No more
                                </span>
                                <Image
            ...
            <Section className="grid gap-12 px-8 md:gap-16">
                ...
                <Container className="grid place-items-center gap-12 rounded-primary pb-24 shadow-shadow1">
                    ...
                    <H3Variant2 className="block max-w-[73.9rem] text-center normal-case text-heading">
                        We will{' '}
                        <span className="w-full font-latoBold text-[2.4rem] normal-case leading-[3.2rem] text-[#FFA500] md:text-[3rem] md:leading-[3.6rem]">
                    ...
                    <div className="grid place-items-center gap-6">
                        ...
                        <div className="mt-4 flex flex-wrap items-center justify-center gap-6">
                            <Button2
                                ...
                                text="0208 445 8877"
                                iconPosition="left"
                                className="group/chat-button !bg-[#003E79] hover:!bg-transparent"
                                icon={
                                    <svg
                                        width="20"
                                        height="20"
                                    ...
                                    >
                                        <g clipPath="url(#clip0_7348_23262)">
                                            <path
                                                ...
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                className="transition-all duration-500 group-hover/chat-button:stroke-[#003E79]"
                                            />
                                        </g>
                                        <defs>
                            ...
                            />
                            <ChatWithUs
                                className="border-[#0099FF] bg-[#0099FF] hover:!text-[#0099FF]"
                                svgClassName="group-hover/chat-button:stroke-[#0099FF]"
                            />
                        </div>
                    </div>
                </Container>
...
export async function getStaticProps() {
    try {
        ...
        let laserTreatments = treatments.filter((treatment) => treatment.group_name === 'Laser eye surgery');
        ...
        /**
         * Updates the `laserTreatments` array by mapping each treatment object and setting the 'active' property based on the index.
         *
         * @param {Array<Object>} laserTreatments - The array of cataract treatment objects to be updated.
         * @returns {Array<Object>} - The updated array of cataract treatment objects.
         */
        laserTreatments = laserTreatments.map((treatment, index) => ({
            ...treatment,
            active: index === 0
        }));
