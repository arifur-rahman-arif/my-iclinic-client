...
export const iclListCataract: NormalSlideInterface[] = [
    {
        ...
        What a team! I was out totally at ease. I can now see clearly without the need for glasses or contact lenses for the first time in sixty years! I  can’t believe it! I will probably need low proscription glasses  to read fine print but I am happy; so happy and grateful. I have my self-confidence back and I am now looking forward to a great future. No longer afraid that I may lose my driving licence. It is miraculous! The aftercare is superb!
    ...
    {
        description: `I was extremely impressed with my entire experience at my-i-clinic. John and his team are super friendly, efficient and reassuring! I would highly recommend using them. I now have the most incredible vision, having been very short sighted since the age of 18.  It was the best decision I made having this procedure. Truly life changing!!  Thank you everyone  🙌`,
        name: 'Amanda Parkes',
        title: 'ICL patient'
    },
    {
...
export const liskListCataract: NormalSlideInterface[] = [
    ...
    {
        description: `Dr Odufuwa was a fantastic doctor. Very kind, gentle and friendly. I gave 4 stars because there was distinct treatment between patients whose are there for a consultation and patients who are there for surgery. Even though I paid a hefty  £350 for consultation, a surgery patient who arrived 1 minute after me was offered coffee and other drinks. £350 is not an amount that you can excluded a cup of cheap coffee. Customers shouldn’t be treated like this. Dr Odufuwa picked up a disorder in my eyes and recommended surgery. I was about to go to my home country and visited an eye hospital there and the second doctor confirmed Dr Odufuwa’s finding. My operation done there and then. I am thankful to doctor Odufuwa. I would strongly recommend her. She know her job well.`,
        name: 'Um Ash',
        title: 'LASIK patient'
    }
];
...
export const normalSlideListKeratoconus: NormalSlideInterface[] = [
    ...
    {
        description: `Competent, friendly and reasonable costs. Had my YAG laser COP treatment on both eyes today. No pain no discomfort at all. Can’t believe how my vision has already improved. Feeling like an eagle. A big Thank You to the team and Mr Bolger.`,
        name: 'Siegrid Dawes'
    }
];
