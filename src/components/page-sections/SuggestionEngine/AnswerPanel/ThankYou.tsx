    ...
    return (
        ...
        >
            <div className="grid h-full place-items-center content-center gap-12">
                <AiOutlineCheck className="h-[6.8rem] w-[6.8rem] fill-[#0186B0]" />
                ...
                <Link
                    href="/"
                    aria-label="Home"
                    className="flex items-center justify-center gap-4 rounded-primary border-2 border-heading2 bg-heading2 py-5 px-20 font-mulishBold text-[1.8rem] leading-[2.8rem] text-white transition-all duration-500 hover:border-white hover:bg-transparent md:mt-12"
                >
                ...
                <div className="grid place-items-center gap-12 md:mt-12">
                    <p className="font-mulishBold text-[1.8rem] text-white">
