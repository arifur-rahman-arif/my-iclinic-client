            ...
            <Container className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-32">
                ...
                {content ? (
                    ...
                    <div className="grid gap-12 md:max-w-[46.7rem]">
                        ...
                        <p>
                            These glaucoma conditions differ in how they present and how they are managed to help
                            remission your symptoms and prevent the potential risk of blindness.
                        </p>
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="grid gap-6">
                                ...
                                <p>
                                    Closed angle glaucoma requires immediate surgery to reduce high pressure in the eye
                                    and prevent damage to the optic nerve which can cause vision loss.
                                </p>
                            </div>
                        </div>
                    </div>
