                    ...
                    <div className="grid gap-6">
                        ...
                        {descriptions?.length
                            ? descriptions.map((item, key) => (
                                  <div
                                      className="max-w-[50rem] text-white [&_*]:!text-white [&_a]:!font-mulishBold [&_a]:underline [&_a]:underline-offset-4 [&_strong]:!font-mulishBold"
                                      key={key}
                                  >
                            ...
                            : null}
                        <span className="font-latoBold text-[2rem] leading-[2.8rem] text-[#94CAFF]">
