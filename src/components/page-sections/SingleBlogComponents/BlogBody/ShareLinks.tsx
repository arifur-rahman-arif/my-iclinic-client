            ...
            >
                <svg width="23" height="22" viewBox="0 0 23 22" fill="" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke={whiteIcon ? '#fff' : '#697072'} strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    <path d="M6.00065 8.25H2.33398V19.25H6.00065V8.25Z" stroke={whiteIcon ? '#fff' : '#697072'}
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round" />
                    <path
                ...
                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_1658_5994)">
                        <path
                            ...
                            fill={whiteIcon ? '#fff' : '#697072'} strokeWidth={4} />
                    </g>
                    <defs>
            ...
            >
                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        stroke={whiteIcon ? '#fff' : '#697072'} strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    <path d="M7.51562 11.8213L13.4919 15.3038" stroke={whiteIcon ? '#fff' : '#697072'} strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round" />
                    <path d="M13.4831 5.69629L7.51562 9.17879" stroke={whiteIcon ? '#fff' : '#697072'} strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round" />
                </svg>
            </button>
            <Link href={'#'} className="cursor-pointer transition-all duration-500 hover:scale-150" onClick={(e) => {
                e.preventDefault();
                window.open(
