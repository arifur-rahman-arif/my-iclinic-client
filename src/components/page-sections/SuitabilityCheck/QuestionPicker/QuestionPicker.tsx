    ...
    return (
        ...
        >
            ...
            <Tooltip
                ...
                className="!rounded-[1rem] border-b border-white !bg-brand"
                arrowClassName="border-b-white"
            >
                <button
                    className="group/reset flex w-full cursor-pointer items-center justify-center gap-6 rounded-[0.5rem] border-2 px-8 py-4 font-mulishBold text-[1.8rem] uppercase leading-[2.8rem] text-white transition-all duration-500 hover:border-brand hover:bg-brand"
            ...
            <span className="text font-latoBold text-[2rem] leading-[2.8rem] text-white md:text-[3rem] md:leading-[3.6rem]">
                What is your age?
            </span>

            <div className="grid w-full place-items-center gap-8 md:-mt-12">
