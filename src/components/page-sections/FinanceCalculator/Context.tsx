...
export interface CalculatorContext {
    ...
    setEyeCount: (index: number, value: 1 | 2) => void;
...
const Context = ({ treatments, children }: PropInterface): JSX.Element => {
    ...
    /**
     * Updates the eyeCount value for a specific index in the treatmentList array.
     *
     * @param {number} index - The index of the element in the treatmentList array to update.
     * @param {1 | 2} value - The new value for the eyeCount property.
     * @returns {void}
     */
    ...
    /**
     * Updates the default upfront percentage value for a specific treatment in the treatment list.
     *
     * @param {number} index The index of the treatment in the treatment list to be updated.
     * @param {number} newDefaultUpfront The new default upfront percentage value to be set.
     * @returns {void}
     */
    ...
    /**
     * Updates the default installment value for a treatment at the specified index in the treatment list.
     *
     * @param {number} index - The index of the treatment in the treatment list.
     * @param {number} value - The new value for the default installment.
     * @returns {void}
     */
