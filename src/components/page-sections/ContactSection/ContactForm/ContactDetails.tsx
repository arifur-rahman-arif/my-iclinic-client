...
const ContactDetails = (): JSX.Element => {
    return (
        <div className="grid content-start overflow-hidden rounded-radius2">
            <Image src={contactFromMap} alt="Map" className="w-full" />

            {/* Grid item #1 */}
            <div className="grid content-start gap-4 bg-brand p-12 md:p-24">
                <div className="flex items-center justify-start gap-4">
                    ...
                    />
                    <span className="text-white">Monday-Friday 9am- 5:30pm</span>
                </div>
                ...
                <div className="flex items-center justify-start gap-4">
                    <Image
                        ...
                        className="translate-y-[0.1rem]"
                    />
                    <span className="text-white">960 High Rd, London N12 9RY</span>
                </div>
                ...
                <div className="flex items-center justify-start gap-4">
                    <Image
                        ...
                        className="translate-y-[0.1rem]"
                    />
                    <a href="mailto:reception@my-iclinic.co.uk" className="text-white">
                ...
                <div className="flex items-center justify-start gap-4">
                    <Image
                        ...
                        className="translate-y-[0.1rem]"
                    />
                    <Link href="tel:0208 445 8877" className="text-white">
                        0208 445 8877
                    </Link>
                </div>

                <span className="mt-12 h-[0.8rem] w-[6.7rem] rounded-[1.6rem] bg-[#FF7F00] md:mt-24"></span>
                <button className="flex items-center justify-start gap-4 text-white" onClick={openFreshdeskChat}>
                ...
                <div className="flex items-center justify-start gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
                            d="M9.97504 1.4502C5.31828 1.45165 1.42769 5.34726 1.42771 10.0002C1.42772 11.6776 1.92698 13.3347 2.85882 14.7356L1.42505 18.5502L6.22619 17.682C7.39901 18.2552 8.68687 18.5424 9.97504 18.5432C14.6358 18.5464 18.53 14.656 18.53 10.0002C18.53 5.3497 14.6344 1.44745 9.97504 1.4502Z"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        />
                        <path
                            d="M10.4456 13.7658C11.6022 14.5084 12.8082 13.9675 13.648 13.3411C14.2281 12.9085 14.2089 12.074 13.7134 11.5465L12.7364 10.5064C12.3658 10.877 11.6436 11.0604 11.1418 10.9077C10.0632 10.5794 9.61047 10.0174 9.24361 9.44592C8.82228 8.78957 9.29808 7.8093 9.6687 7.4387L8.57968 6.4445C8.12057 6.02538 7.42322 5.95466 7.02264 6.43004C6.23006 7.37058 5.73714 8.79852 6.3209 9.70774C7.36884 11.3399 8.81326 12.718 10.4456 13.7658Z"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <Link href="https://wa.me/+447850395332" target="_blank" className="text-white">
                        WhatsApp
                    </Link>
                </div>

                {/*     Social media links */}
                <div className="mt-12 flex flex-wrap items-start gap-4 md:mt-16">
                    {/* Twitter */}
                    <Link
