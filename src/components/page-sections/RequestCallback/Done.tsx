...
const Done = (): JSX.Element => {
    ...
    return (
        <div className="grid grid-cols-1 place-items-center content-start gap-6" id="request-callback-confirmation">
            {/* <Image src="/images/section-images/check-circle.webp" alt="" width={47} height={47} /> */}
            {componentRendered && <LottieComponent />}

            <div className="-mt-12 flex w-full flex-col items-center justify-start gap-2">
                <span
