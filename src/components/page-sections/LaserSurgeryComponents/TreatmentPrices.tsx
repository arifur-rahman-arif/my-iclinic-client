...
const Card = ({ title, description, price }: CardProps) => {
    return (
        <div className="grid max-w-[29.5rem] translate-y-12 content-start gap-12 rounded-radius2 border border-solid border-[#EAECF0] p-10 opacity-0 shadow-md transition-all duration-500 hover:shadow-shadow1">
            ...
            <div className="grid grid-cols-[auto_1fr] items-center gap-8">
                <Tooltip
                    text={<span className="whitespace-nowrap font-mulishBold">Book a consultation</span>}
                    className="p-4"
                >
                    <Link
