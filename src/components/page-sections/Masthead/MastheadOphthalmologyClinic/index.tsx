 ...
 * section of the London Ophthalmology Clinic website. It displays information about the clinic,
        ...
        <div className={`${styles.styles} relative grid overflow-hidden`}>
            ...
            <div className="grid gap-6 bg-[#0052A0] px-8 py-12 md:bg-transparent xl:pl-[calc(calc(100vw_-_var(--container-width))_/_2)]">
                <h1 className="max-w-[56rem] font-latoExtraBold text-[3.6rem] normal-case leading-[4rem] text-white md:text-[4.8rem] md:leading-[4.8rem]">
                    The London Ophthalmology clinic
                </h1>
            ...
            <Image
                src={mastheadImage}
                alt="The London Ophthalmology clinic"
...
/**
 * `Reviews` is a React functional component that displays reviews and ratings for the London Ophthalmology Clinic
...
const Reviews = (): JSX.Element => {
    return (
        <div className="relative z-[2] col-start-1 row-start-2 mt-6 flex flex-wrap items-stretch justify-start gap-4 self-start justify-self-start pl-8 md:row-start-2 md:mt-24 md:ml-8 md:grid md:grid-cols-2 md:items-end md:rounded-[0.5rem] md:bg-white md:px-8 md:py-2 xl:mt-32 xl:ml-[calc(calc(100vw_-_var(--container-width))_/_2)]">
            {/* Review 1 */}
            <div className="grid grid-cols-1 place-items-center gap-4 rounded-[0.5rem] bg-white p-4 md:col-start-2 md:row-start-1 md:w-full md:max-w-[19.8rem] md:place-items-start md:py-4 xl:gap-2">
            ...
            {/* Review 2 */}
            <div className="grid grid-cols-[auto_1fr] items-center justify-start gap-2 rounded-[0.5rem] bg-white p-4 md:w-full md:max-w-[19.8rem] md:grid-cols-[auto_auto] md:justify-start md:gap-0 md:py-4 ">
 ...
 * addressed by the London Ophthalmology Clinic. It provides a visual representation of these conditions, including
...
const Conditions = (): JSX.Element => {
    return (
        <div className="-mt-36 grid gap-12 md:mt-12 md:translate-y-0 md:grid-cols-[auto_1fr] md:gap-0 lg:mt-24 xl:mt-32 xl:grid-cols-[auto_1fr_1fr]">
            <span className="px-8 font-mulishBold text-[1.8rem] leading-[2.8rem] text-white md:bg-[#003E79] md:py-24 md:text-[2.4rem] md:leading-[3.2rem] lg:px-16 xl:pl-[calc(calc(100vw_-_var(--container-width))_/_2)]">
                We address a wide range <br />
                <span className="flex items-center justify-start gap-4 font-mulishBold text-[1.8rem] leading-[2.8rem] text-white md:text-[2.4rem] md:leading-[3.2rem]">
                    of conditions
                    <AiOutlineArrowDown
                        fill="white"
