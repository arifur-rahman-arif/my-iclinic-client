    ...
    return (
        ...
        >
            ...
            <Banner
                ...
                bannerClassName="!rounded-none xl:max-w-[75rem] md:!pr-16 xl:rounded-none xl:!rounded-tr-primary xl:!rounded-br-primary py-10 bg-[#003E79] xl:self-center md:max-w-full lg:content-center xl:pl-[calc(calc(100vw_-_var(--container-width))_/_2)] relative z-[2] xl:col-start-1 xl:row-start-1 xl:col-span-2"
