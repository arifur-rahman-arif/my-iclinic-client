...
const FinanceHeroSection = ({
    ...
    return (
        <Section
            ...
            className="md:min-h-[50rem] lg:grid-cols-[1fr_auto] xl:grid-cols-[auto_50rem_1fr] 2xl:grid-cols-[auto_50rem_1fr]"
        >
            <div className="relative z-[1] lg:order-2 lg:min-h-[63.3rem] xl:col-span-2 xl:col-start-2 xl:row-start-1 xl:max-h-[70rem]">
                <Image
                    src={image}
                    alt={altText || ''}
                    width={1140}
            ...
            <Banner
                ...
                bannerClassName="!rounded-none md:!pr-16 xl:rounded-none xl:!rounded-tr-primary xl:!rounded-br-primary py-10 bg-[#003E79] xl:self-center md:max-w-full lg:content-center xl:pl-[calc(calc(100vw_-_var(--container-width))_/_2)] relative z-[2] xl:col-start-1 xl:row-start-1 xl:col-span-2"
