...
const Masthead2 = ({ title, subTitle, image, googleReviews, trustPilotReviews }: Masthead2Props): JSX.Element => {
    ...
    return (
        <main className="mt-8">
            <div className="grid gap-16 px-8 md:grid-cols-2 lg:gap-12 xl:ml-[calc(calc(100%_-_var(--container-width))_/_2)] xl:grid-cols-[auto_1fr] xl:px-0">
                ...
                <div className="grid gap-4 xs:grid-cols-[minmax(23rem,_1fr)_1fr] md:max-h-[58.2rem] lg:gap-6 xl:grid-rows-[1fr_auto] xl:gap-10">
                    ...
                    <Image
                        ...
                        height={582}
                        priority={true}
                        className="h-full max-h-[30rem] w-full rounded-primary object-cover xs:max-h-full xl:row-span-2 xl:rounded-br-none xl:rounded-tr-none"
                    />
                    <div className="grid grid-flow-col gap-2 rounded-primary bg-brandLight p-6 xs:col-span-full xl:col-span-1 xl:self-start xl:p-14">
                        <Image
