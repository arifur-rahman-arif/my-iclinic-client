...
interface EpiretinalMembraneProps extends Pick<RetinaTreatmentsContents, 'section7'> {}
    ...
    return (
        <Section className="px-8 xl:px-0">
            <Container className="grid items-center gap-12 rounded-primary bg-brandLight py-12 md:grid-cols-2 lg:gap-24 lg:py-24 xl:gap-28">
                ...
                <SectionTextColumn
                    heading={section7?.heading || 'Epiretinal Membrane'}
                    descriptionContainerClassName="max-w-[50rem]"
                    descriptions={
                        (section7?.descriptions?.length && section7.descriptions) || [
