...
interface OphthalmologistDoctorsProps extends Pick<RetinaTreatmentsContents, 'section1'> {}
    ...
    return (
        <Section id="ophthalmologist-doctors">
            <Container className="grid items-center gap-12 md:grid-cols-2 md:gap-24 xl:gap-28">
                ...
                <SectionTextColumn
                    heading={section1?.heading || 'My-iClinic ophthalmologists are medical doctors'}
                    descriptions={
                        (section1?.descriptions?.length && section1.descriptions) || [
