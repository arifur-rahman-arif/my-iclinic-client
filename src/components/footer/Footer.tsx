...
import IconTelephone from '@/icons/icon-telephone-outline.svg';
...
const Footer = () => {
    return (
        <footer className="bg-headingColor relative mt-24 w-full sm:mt-36 md:mt-[30rem]">
            <img
            ...
            <Container className="grid grid-cols-1 justify-items-center pt-32 pb-16">
                <h3 className="text-primary mt-4 normal-case">Get in touch ..</h3>
