        ...
        <>
            ...
            >
                <span onClick={() => setExpanded(!expanded)} className="grid cursor-pointer place-items-start">
                    {expanded ? (
                        <Image src="/images/icons/icon-minus-dark-bg.svg" alt="" width={34} height={34} quality={60} />
                    ) : (
                        <Image src="/images/icons/icon-plus-dark-bg.svg" alt="" width={34} height={34} quality={60} />
                    )}
                </span>
