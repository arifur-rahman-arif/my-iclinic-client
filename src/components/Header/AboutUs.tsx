...
const AboutUs = () => {
    ...
    return (
        <span className="group/menu-item parent-menu flex items-center justify-center gap-2">
            ...
            <div
                className="mega-submenu absolute left-0 top-full z-[99] grid max-h-0 w-screen grid-rows-[1fr_auto] overflow-y-auto overflow-x-hidden bg-white transition-all duration-1000 group-hover/menu-item:max-h-[calc(100vh_-_19rem)] group-hover/menu-item:drop-shadow-md xl:top-0 xl:translate-y-[11rem]">
