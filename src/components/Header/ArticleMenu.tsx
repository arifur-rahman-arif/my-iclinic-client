                                ...
                                <div className={`hidden content-start gap-12 md:grid`}>
                                    ...
                                    <div className={`grid grid-cols-1 gap-y-12 gap-x-24`}>
                                        ...
                                        >
                                            ...
                                            <span className="flex items-center justify-center gap-3 rounded-primary bg-heading2 py-3 px-5 font-mulishExtraBold text-[1.2rem] uppercase leading-[1.8rem] text-white text-[#697072]">
                                                Go to article page
