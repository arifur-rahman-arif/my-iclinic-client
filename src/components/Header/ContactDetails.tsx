    ...
    return (
        <div className="flex grid-flow-col items-center justify-center gap-6 justify-self-end">
            ...
            <BookConsultation
                ...
                maxWidth="70rem"
                buttonClassName={`group/consultation transition-all border-2 border-white duration-500 hover:bg-white hover:!border-heading2 grid cursor-pointer px-8 py-6 place-items-center gap-5 bg-heading2 grid-flow-col rounded-primary`}
            >
