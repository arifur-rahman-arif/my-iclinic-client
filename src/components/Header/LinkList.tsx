            ...
            {type === 'text' && (
                <li
                    className={`w-full cursor-pointer whitespace-nowrap text-center underline-offset-8 transition-all hover:underline md:w-auto ${
                        linkActive && 'decoration-primary underline'
                    }`}
                    onClick={closeMenu}
                >
            ...
            {type === 'button' && (
                <li onClick={closeMenu}>
                    <Link href={url}>
                        <button
                            type="button"
                            className={`text-secondar border-primary bg-primary hover:text-primary cursor-pointer rounded-[1.5rem] border-2 py-[1.8rem] px-[2.4rem] text-[1.6rem] font-bold uppercase leading-8 transition-all hover:bg-transparent`}
                        >
                            Calendar
                        </button>
                    </Link>
