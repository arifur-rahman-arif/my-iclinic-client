...
const Button = ({
    ...
    mockDisabled = false,
    className,
    defaultClassName = 'grid cursor-pointer grid-flow-col place-items-center gap-4 whitespace-nowrap rounded-primary border-2 border-brand bg-brand py-6 px-6 font-latoBold text-[1.6rem] capitalize outline-0 transition-all duration-300 focus-within:border-2 hover:bg-white focus:border-2 focus:border-brand hover:shadow-shadow1 focus-visible:border-2 sm:px-8',
    onClick,
    ...other
